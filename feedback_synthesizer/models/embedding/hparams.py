...
hparams = tf.contrib.training.HParams(
	...
	hop_size = 256, #For 16000Hz, 256 ~= 16 ms (0.016 * sample_rate)
	win_size = 1024, #For 16000Hz, 1024 ~= 64 ms (If None, win_size = n_fft) (0.064 * sample_rate)
	sample_rate = 16000, #16000 Hz (corresponding to ljspeech dataset) (sox --i <filename>)
	...
	griffin_lim_iters = 120, #Number of G&L iterations, typically 30 is enough but we use 60 to ensure convergence.
