...
hparams = HParams(
    ...
    tacotron_batch_size=20,  # number of training samples on each training steps (was 32)
    ...
    embed_loss_scale = 1.0,
    embed_loss_func = 'cos',
    
    restore_tacotron_path = 'synthesizer/saved_models/logs-vctk/taco_pretrained/tacotron_model.ckpt-4000000',
    # restore_spv_path = 'deep_speaker/vox12_resnet34_pretrain/gvector.ckpt-300000'
    restore_spv_path = 'deep_speaker/vox12_resnet34/gvector.ckpt-0'
)
