...
def build_from_path(hparams, input_dirs, mel_dir, linear_dir, wav_dir, n_jobs=1, tqdm=lambda x: x):
    """
...
def _process_utterance(mel_dir, linear_dir, wav_dir, spkid, uttid, wav_path, text, hparams):
    """
